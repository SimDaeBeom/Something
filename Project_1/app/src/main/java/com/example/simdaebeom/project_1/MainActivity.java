...
public class MainActivity extends AppCompatActivity {
    ...
    public void moveunderstand(View view) {
        startActivity(new Intent(this,UnderstandActivity.class));
    }

    public void moveuncare(View view) {
        startActivity(new Intent(this,CareActivity.class));
    }

    public void movemeal(View view) {
        startActivity(new Intent(this,MealActivity.class));
    }

    public void movelife(View view) {
    ...
    public void moveinfo(View view) {
